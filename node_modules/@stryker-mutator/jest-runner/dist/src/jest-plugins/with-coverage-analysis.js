...
function setupFramework(jestConfig, overrides) {
    ...
    if (setupFile) {
        ...
        throw new Error(`The @stryker-mutator/jest-runner doesn't support ${util_1.propertyPath('coverageAnalysis')} "perTest" with "jestConfig.testRunner": "${jestConfig.testRunner}". Please open an issue if you want support for this: https://github.com/stryker-mutator/stryker/issues`);
    }
}
