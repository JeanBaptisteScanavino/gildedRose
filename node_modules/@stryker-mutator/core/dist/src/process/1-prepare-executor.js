...
const input_file_resolver_1 = require("../input/input-file-resolver");
...
class PrepareExecutor {
    ...
    async execute() {
        ...
        const inputFiles = await mainInjector.injectClass(input_file_resolver_1.InputFileResolver).resolve();
